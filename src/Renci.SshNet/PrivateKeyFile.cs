...
namespace Renci.SshNet
{
    ...
    public class PrivateKeyFile : IDisposable
    {
        ...
        private void Open(Stream privateKey, string passPhrase)
        {
            ...
            switch (keyName)
            {
                ...
                case "OPENSSH":
                    ...
                    HostKey = new KeyHostAlgorithm("ssh-ed25519", _key);
                    break;
                default:
        ...
        /// <returns></returns>
        private EdDSAKey ParseOpenSshV1Key(byte [] keyFileData, string passPhrase)
        {            
            ...
            return new EdDSAKey(publicKey, unencryptedPrivateKey);
        }
